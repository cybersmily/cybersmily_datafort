...
export class CrCzReleasesDataService {
    ...
    get releaseList(): Observable<Array<KeyValue<string, string>>> {
      if(this._releasesList) {
        ...
        return this.dataService
          ...
          .pipe( map( (data: Array<KeyValue<string,string>>) => {
    ...
    GetFullReleaseNames(abbreviations: Array<string>): Observable<Array<string>> {
      return this.releaseList.pipe(map((data: Array<KeyValue<string,string>>) => {
