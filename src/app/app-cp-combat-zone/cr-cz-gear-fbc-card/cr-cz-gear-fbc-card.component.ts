...
@Component({
    selector: 'cs-cr-cz-gear-fbc-card',
    templateUrl: './cr-cz-gear-fbc-card.component.html',
    styleUrls: ['./cr-cz-gear-fbc-card.component.css'],
    standalone: false
})
export class CrCzGearCardFBCComponent implements OnInit {
  faStar = faStar;
  faTrash = faTrash;
  faPlus = faPlus;
