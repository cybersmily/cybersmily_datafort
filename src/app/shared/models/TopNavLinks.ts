    ...
    constructor() {
      ...
      this.menuItems.push({
        ...
        links: [
          ...
          {title: 'Master Cyberdecks List', link: 'data/cyberdeck', desc: 'List of all canon Cyberdecks in Cyberpunk 2020'},
          {title: 'Master Programs List', link: 'data/programs', desc: 'List of all canon programs in Cyberpunk 2020'},
      ...
      this.menuItems.push({
        ...
        links: [
          ...
          {title: 'Datafort Designer', link: 'apps/dfdesigner', desc: 'Datafort designer for Cyberpunk 2020.'},
      ...
      this.menuItems.push({
        ...
        links: [
          ...
          {title: 'Cybernation Uncensored', link: 'https://www.cybernationuncensored.com/',
