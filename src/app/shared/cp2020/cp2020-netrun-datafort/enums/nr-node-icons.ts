export enum NrNodeIcons {
  ...
  LDL = '<rect x="31" y="31" fill="white" stroke="black" stroke-width="50" width="450" height="450" />' +
          '<polygon points="51,390 256,145 450,390" fill="black" stroke="black" stroke-width="1" />',
  TERMINAL = '<rect x="76" y="31" width="250" height="280" stroke="black" stroke-width="50" fill="white"/>' +
  ...
  MICROPHONE = '<circle cx="181" cy="256" r="135" stroke="black" stroke-width="50" fill="white" />' +
                 '<line x1="321" x2="481" y1="256" y2="256" stroke="black" stroke-width="50" />',
  CAMERA = '<rect x="31" y="81" width="350" height="350" stroke="black" stroke-width="50" fill="white"/>' +
  ...
  VIDEO =  '<rect x="51" y="51" fill="white" stroke="black" stroke-width="50" width="400" height="400" />' +
             '<line x1="56" x2="456" y1="56" y2="456" stroke="black" stroke-width="50" />' +
             '<line x1="456" x2="56" y1="56" y2="456" stroke="black" stroke-width="50" />',
  PRINTER = '<polygon points="101,31 352,31 417,131 417,437 101,437" fill="white" stroke="black" stroke-width="50" />' +
  ...
  VEHICLE =  '<rect x="31" y="106" fill="white" stroke="black" stroke-width="50" width="450" height="150" />' +
  ...
  ALARM = '<circle cx="256" cy="256" r="180" stroke="black" stroke-width="50" fill="white" />' +
            '<line x1="236" x2="481" y1="276" y2="31" stroke="black" stroke-width="50" />',
  DOOR = '<rect x="31" y="206" fill="white" stroke="black" stroke-width="50" width="200" height="250" />' +
         '<line x1="226" x2="486" y1="312" y2="181" stroke="black" stroke-width="50" />',
  ELEVATOR = '<rect x="116" y="151" fill="white" stroke="black" stroke-width="50" width="280" height="280" />' +
