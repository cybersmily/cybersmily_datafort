import { NrNodeType, NrNodeIcons } from '../../enums';
...
export class Cp2020DatafortToolbarComponent implements OnInit {
  ...
  icons = [
    {
      title: 'Datawall Node',
      type: NrNodeType.DATAWALL,
      icon: NrNodeIcons.DATAWALL,
    },
    {
      title: 'Codegate Node',
      type: NrNodeType.CODEGATE,
      icon: NrNodeIcons.CODEGATE,
    },
    { title: 'CPU Node', type: NrNodeType.CPU, icon: NrNodeIcons.CPU },
    { title: 'Memory Unit Node', type: NrNodeType.MU, icon: NrNodeIcons.MU },
    {
      title: 'Program Node',
      type: NrNodeType.PROGRAM,
      icon: NrNodeIcons.PROGRAM,
    },
    { title: 'LDL Node', type: NrNodeType.LDL, icon: NrNodeIcons.LDL },
    {
      title: 'Terminal Node',
      type: NrNodeType.TERMINAL,
      icon: NrNodeIcons.TERMINAL,
    },
    { title: 'Camera Node', type: NrNodeType.CAMERA, icon: NrNodeIcons.CAMERA },
    {
      title: 'Microphone Node',
      type: NrNodeType.MICROPHONE,
      icon: NrNodeIcons.MICROPHONE,
    },
    {
      title: 'Videoscreen Node',
      type: NrNodeType.VIDEO,
      icon: NrNodeIcons.VIDEO,
    },
    {
      title: 'Holodisplay Node',
      type: NrNodeType.HOLODISPLAY,
      icon: NrNodeIcons.HOLODISPLAY,
    },
    {
      title: 'Printer Node',
      type: NrNodeType.PRINTER,
      icon: NrNodeIcons.PRINTER,
    },
    ...
    {
      title: 'Elevator Node',
      type: NrNodeType.ELEVATOR,
      icon: NrNodeIcons.ELEVATOR,
    },
    {
      title: 'Manipulator Node',
      type: NrNodeType.MANIPULATOR,
      icon: NrNodeIcons.MANIPULATOR,
    },
    {
      title: 'Autofactory Node',
      type: NrNodeType.AUTOFACTORY,
      icon: NrNodeIcons.AUTOFACTORY,
    },
    {
      title: 'Remote Vehicle/Robot Node',
      type: NrNodeType.VEHICLE,
      icon: NrNodeIcons.VEHICLE,
    },
  ];
  ...
  getCount(nodeType: NrNodeType): number {
    const numOfCodegates =
      this.currDatafort.cpu - this.currDatafort.codegates.length;
    const numOfMUs =
      this.currDatafort.cpu * 4 - this.currDatafort.muNodes.length;
